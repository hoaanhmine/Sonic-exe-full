...
function onEvent(name,v1)
    if name == 'Genesis' then
        if string.lower(v1) ~= 'false' then
            ...
            setProperty('greenHill.x',getProperty('boyfriend.x') - 1300)
            setProperty('greenHill.y',getProperty('boyfriend.y') - 600)
            setPropertyFromClass('PlayState','isPixelStage',true)
            setProperty('boyfriend.x',getProperty('greenHill.x') + 1500 +  getProperty('boyfriend.positionArray[0]'))
            setProperty('boyfriend.y',getProperty('greenHill.y') + 600 + getProperty('boyfriend.positionArray[1]'))

            setProperty('dad.x',getProperty('greenHill.x') + 850 + getProperty('dad.positionArray[0]'))
            ...
            setProperty('gf.x',getProperty('greenHill.x') + 900 + getProperty('gf.positionArray[0]'))
            setProperty('gf.y',getProperty('greenHill.y') + 600 + getProperty('gf.positionArray[1]'))
        else
