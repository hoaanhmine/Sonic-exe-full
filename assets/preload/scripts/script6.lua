...
function onCreate()
        if string.lower(songName) ~= '' and
        string.lower(songName)  ~= 'chaos'  and
        string.lower(songName)  ~= '' and
        string.lower(songName)  ~= '' and
        string.lower(songName)  ~= '' and
	    ...
	    string.lower(songName)  ~= 'b4cksl4sh' and
        string.lower(songName)  ~= 'personel' and	
        string.lower(songName)  ~= '' and	
        string.lower(songName)  ~= '' and		
		string.lower(songName)  ~= '' and
		string.lower(songName)  ~= 'endless-jp' and		
		string.lower(songName)  ~= 'endless-us' and	
		string.lower(songName)  ~= '' and		
		string.lower(songName)  ~= '' and		
		string.lower(songName)  ~= '' and	
		string.lower(songName)  ~= '' and	
		string.lower(songName)  ~= 'round-a-bout' and
		string.lower(songName)  ~= '' and	
		string.lower(songName)  ~= '' and	
		string.lower(songName)  ~= '' and		
		string.lower(songName)  ~= '' and
        ...
        elseif string.lower(songName)  == 'you-cant-run-encore!' then
            startSonicCount('you-cant-run')	
        elseif string.lower(songName)  == 'b4cksl4sh' then
            startSonicCount('b4cksl4sh')				
        ...
        elseif string.lower(songName) == 'sunshine-encore' then
            changeCountDown('-Tails','StartScreens/tails_',true,true,false,true,1,1,300,230) 
