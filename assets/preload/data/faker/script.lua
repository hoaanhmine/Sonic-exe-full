...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	CoderName1 = 'Port by Wolfie_1985'
	CoderName2 = 'Original code from Futagami Sonic.EXE Build'
	CoderName3 = 'Script by RamenDominoes'
	CoderName4 = ''
...
Start = 10 --choose which "STEP" to activate the script on
