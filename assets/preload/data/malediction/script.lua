...
-----------------------------------------------------------------------
	...
	--------CODING CREW--------
	--CODER 1
	makeLuaText('CODER1', 'Events by Wolfie_1985', 1000, 132, -1000)
	...
	--CODER 2
	makeLuaText('CODER2', 'Whoever made this originally', 1000, 132, -1000)
	...
	--CODER 3
	makeLuaText('CODER3', 'Script by RamenDominoes', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Sonic.EXE FNF crew', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Curse Owned by Kenji Grimm', 1000, 132, -1000)
	...
	--ARTIST 3
	makeLuaText('ARTIST3', 'Background by R&S productions', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Malediction by Bbpanzu', 1000, 132, -1000)
	...
	--MUSICIAN 2
	makeLuaText('MUSICIAN2', 'Malediction by UpTaunt', 1000, 132, -1000)
	...
	--MUSICIAN 3
	makeLuaText('MUSICIAN3', 'Voice of curse by Illuztriouz', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'Wolfie_1985', 1000, 132, -1000)
	...
	--CHARTER 2
	makeLuaText('CHARTER2', 'Whoever charted this originally', 1000, 132, -1000)
	...
	--CHARTER 3
	makeLuaText('CHARTER3', '', 1000, 132, -1000)
